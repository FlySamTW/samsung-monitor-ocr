...
9. 第一、第二、第三輪的三層即時守門，必須遵循 [three_layer_accuracy_gate.md](three_layer_accuracy_gate.md)。內容不一致由 `.22` 定案器保守收旂；每張照片總模型呼叫硬上限為三次，只有請求綁定、跨圖汙染、系統輸出或 Drive 回讀等技術錯誤可不上傳該張。
