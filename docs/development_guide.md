...
- Human-audited pixel authority may settle a result only when the full-image SHA-256 matches and exactly three request-bound, stateless, uncontaminated model calls completed. It is a bounded manual adjudication, never a filename heuristic and never permission for a fourth call. Permanent authorities: `649=S27CG552EC/4990`, `668=S32FM703UC/9990` without FollowMe fixture evidence, `673=S27FG532EC/4990`, `674=S27D300GAC/3090`; all four are single-unit with `complete_screen_count=1`.
