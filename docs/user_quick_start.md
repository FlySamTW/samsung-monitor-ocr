...
- 看速度時要看「現行守門已驗證且可逐張上傳的照片／小時」，不要看模型呼叫數。介面有在換圖但內容把邊緣螢幕算完整、借用背景系列名稱，仍屬跑歪。
- 交期必須分開顯示「照最近 24 小時的實際預測」與「目標所需速率」。2026-07-17 基準是 259 張／日，照此為 2027-06-11；要在 2026-09-06 完成，須穩定達到 1,667 張／日。
